...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        was_published_recently() returns True for questions whose pub date is
        within the last day.
        :return:
        """
        time = timezone.now() - datetime.timedelta(hours=23, minutes=59, seconds=59, milliseconds=20)
...
class QuestionIndexViewTest(TestCase):
    def test_no_questions(self):
        ...
        self.assertContains(response, "No polls are available as yet.")
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        The detail view of a question with a pub-date in the past displays
        the question's text.
        :return:
        """
